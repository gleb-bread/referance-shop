...
import { p as propsFactory, m as makeComponentProps, s as makeDimensionProps, g as genericComponent, t as useDimension, f as useRender, S as SUPPORTS_INTERSECTION, h as convertToUnit, o as defineStore, x as useAsyncData, v as useCookie, w as useFetch } from '../server.mjs';
...
const fetchRequest = async function(url, opts) {
  ...
  const { data } = await useFetch(`${mainSait}${url}`, opts, "$ErTr1ttAwh");
  return data;
};
const actions = {
...
//# sourceMappingURL=index-023a63c0.mjs.map
