import { createVNode, toRef, shallowRef, computed, ref, watchEffect, mergeProps, useSSRContext, inject, provide, reactive, watch, readonly, defineComponent, withCtx, renderSlot, createTextVNode } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot } from 'vue/server-renderer';
import { p as propsFactory, m as makeComponentProps, f as makeThemeProps, g as genericComponent, i as provideTheme, Z as useRtl, n as useRender, e as makeTagProps, s as makeBorderProps, v as makeElevationProps, b as makeRoundedProps, $ as useBackgroundColor, A as useBorder, C as useElevation, k as useRounded, q as provideDefaults, r as VDefaultsProvider, a1 as convertToUnit, af as VExpandTransition, H as useProxiedModel, Y as useToggleScope, _ as _export_sfc, X as getUid, ad as getCurrentInstance, ac as useResizeObserver, ae as findChildrenWithProvide, ag as clamp, K as VBtn } from '../server.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(ssrRenderComponent(VAppBar, mergeProps({
    ...
    prepend: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(VBtn, { icon: "mdi-menu" }, null, _parent2, _scopeId));
      } else {
        return [
          createVNode(VBtn, { icon: "mdi-menu" })
        ];
      }
    }),
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(VMain, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_header_app, null, null, _parent3, _scopeId2));
...
//# sourceMappingURL=default-b31f9851.mjs.map
