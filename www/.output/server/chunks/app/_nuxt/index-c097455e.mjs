import { _ as __nuxt_component_0 } from './nuxt-link-985b5af2.mjs';
import { defineComponent, ref, mergeProps, withCtx, unref, isRef, createTextVNode, createVNode, withModifiers, useSSRContext } from 'vue';
import { V as VForm, a as VTextField, u as useFormRules } from './rules-edbf1a0d.mjs';
import { ssrRenderComponent } from 'vue/server-renderer';
import { V as VContainer } from './VContainer-9d9fd019.mjs';
import { V as VRow, a as VCol } from './VRow-43dcefd1.mjs';
import { V as VBtn } from '../server.mjs';
import { V as VImg } from './index-023a63c0.mjs';
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<h1${_scopeId5}>Reset password</h1><p class="text-medium-emphasis"${_scopeId5}>Add your email to get instructions</p>`);
                                    _push6(ssrRenderComponent(VForm, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<div class="mt-1"${_scopeId6}><label class="label text-grey-darken-2" for="email"${_scopeId6}>Email</label>`);
                                          ...
                                          _push7(ssrRenderComponent(VBtn, {
                                            ...
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`Send instructions`);
                                              } else {
                                                return [
                                                  createTextVNode("Send instructions")
                                                ];
                                              }
                                            }),
                                            _: 1
                                    ...
                                    _push6(`<p class="text-body-2 mt-10"${_scopeId5}><span${_scopeId5}>Don&#39;t have an account? `);
                                    ...
                                    return [
                                      createVNode("h1", null, "Reset password"),
                                      createVNode("p", { class: "text-medium-emphasis" }, "Add your email to get instructions"),
                                      createVNode(VForm, {
...
//# sourceMappingURL=index-c097455e.mjs.map
